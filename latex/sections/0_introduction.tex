\section{Introduction: What's MLOps?}
\noindent
...
%! key note:
%% Most of the time, the real challenge is not to build the model,
%% the challenge is to build and integrated ML system and continuously operate 
%% it in production. 


\subsection{The Key Components of MLOps}
...
% https://www.mechanicalrock.io/blog/a-brief-overview-on-mlops-workflow-components
...
% https://mlops-for-all.github.io/en/docs/introduction/component/
