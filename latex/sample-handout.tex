...
\input{sections/0.1_plan.tex}
\input{sections/0.2_mlops.tex}
\input{sections/2_pipeline.tex}
\input{sections/2.1_data_eng.tex}
\input{sections/2.2_training_data.tex}
